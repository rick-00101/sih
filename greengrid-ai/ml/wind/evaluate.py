"""
GreenGrid AI — Wind model evaluation (standalone check)
Loads the saved model (no retraining) and re-confirms test metrics.
"""
import json
import joblib
import numpy as np
...
MODEL_DIR = Path(__file__).resolve().parents[2] / "backend" / "models" / "wind_model"
